...
const Option1Basic = () => {
  return (
    <div className={styles.option1Basic1}>
      <div className={styles.defaultToggle}>
          ...
          <div className={styles.widget6}>
            <div className={styles.col5}>
              <div className={styles.row5}>
                <img
                  className={styles.buttonTrashIcon10}
                  alt=""
                  src="/button-trash@2x.png"
                />
                <img
                  className={styles.buttonEditIcon10}
                  alt=""
                  src="/button-edit@2x.png"
                />
                <img
                  className={styles.buttonSettingsIcon10}
                  alt=""
            ...
            <div className={styles.col1}>
              <div className={styles.item51}>
                ...
                <img
                  className={styles.kickstarterIcon2}
                  alt=""
              ...
              <div className={styles.item21}>
                ...
                <div className={styles.item5Child} />
                <img
                  className={styles.telegramIcon2}
                  alt=""
            ...
            <div className={styles.head}>
              ...
              <div className={styles.moreThan4004}>
        ...
        <div className={styles.sidebar}>
          ...
          <div className={styles.highlightedRectangle3} />
          <img className={styles.topPartIcon} alt="" src="/top-part@2x.png" />
          <div className={styles.iconsBright}>
            <img className={styles.layersIcon2} alt="" src="/layers@2x.png" />
            <img
              className={styles.layout4Blocks2}
              alt=""
          ...
          <div className={styles.iconsFaded}>
            <div className={styles.box3}>
              <div className={styles.bound5} />
            </div>
            <img
              className={styles.barcodeReadIcon1}
              alt=""
        ...
        <div className={styles.sunheader}>
          ...
          <div className={styles.left}>
            ...
            <div className={styles.addNewButton2}>
          ...
          <div className={styles.right}>
            ...
            <div className={styles.actionsButtonPassive2}>
              <div className={styles.todayActiveChild} />
              <div className={styles.actions}>Actions</div>
            </div>
            <div className={styles.actionsButtonActive2}>
              <div className={styles.actionsButtonActiveChild} />
              <div className={styles.actions1}>Actions</div>
              <img className={styles.sort1Icon2} alt="" />
            </div>
            <img
              className={styles.filePlusIcon2}
              alt=""
        ...
        <div className={styles.header}>
          ...
          <div className={styles.right1}>
            <div className={styles.icons}>
              <img className={styles.searchIcon2} alt="" src="/search@2x.png" />
              <img
                className={styles.compilingIcon3}
                alt=""
                src="/compiling@2x.png"
              />
              <div className={styles.equalizer}>
                <div className={styles.bound5} />
                <div className={styles.rectangle62Copy7} />
                <div className={styles.rectangle62Copy24} />
                <div className={styles.rectangle62Copy44} />
                <div className={styles.rectangle62Copy34} />
              </div>
              <img
                className={styles.stockholmIconsShoppingC2}
                alt=""
                src="/stockholm-icons--shopping--cart3@2x.png"
              />
              <img
                className={styles.layout4BlocksIcon2}
                alt=""
      ...
      <div className={styles.tabs1}>
        ...
        <div className={styles.item23}>
          <div className={styles.iconText6}>
            ...
            <img
              className={styles.layout4BlocksIcon3}
              alt=""
              src="/layout4blocks@2x.png"
            />
          </div>
        ...
        <div className={styles.item43}>
          <div className={styles.iconText8}>
            ...
            <div className={styles.equalizer1}>
              <div className={styles.bound5} />
              <div className={styles.rectangle62Copy8} />
              <div className={styles.rectangle62Copy25} />
              <div className={styles.rectangle62Copy45} />
              <div className={styles.rectangle62Copy35} />
            </div>
          </div>
        </div>
        <div className={styles.item53}>
      ...
      <div className={styles.defaultToggle1}>
        <div className={styles.widgets1}>
          <div className={styles.widget7}>
            ...
            <div className={styles.col6}>
              <img className={styles.buttonIcon1} alt="" />
              <div className={styles.buttonBookmark}>
                <div className={styles.background36} />
                <img className={styles.bookmark1Icon1} alt="" />
              </div>
            ...
            <div className={styles.col51}>
              <div className={styles.item54}>
                ...
                <div className={styles.div}>Kobe Leonard</div>
              </div>
              <div className={styles.item44}>
                <div className={styles.avarage}>Avarage</div>
                <img className={styles.starIcon18} alt="" />
                <img className={styles.starIcon19} alt="" />
                <img className={styles.starIcon20} alt="" />
                <img className={styles.halfStartIcon2} alt="" />
                <img className={styles.starIcon21} alt="" />
              </div>
              ...
              <div className={styles.item24}>
                ...
                <img className={styles.starIcon27} alt="" />
                <img className={styles.starIcon28} alt="" />
                <img className={styles.starIcon29} alt="" />
                <img className={styles.starIcon30} alt="" />
                <img className={styles.halfStartIcon3} alt="" />
              </div>
            ...
            <div className={styles.col31}>
              <div className={styles.item54}>
                <div className={styles.paid5}>Paid</div>
            ...
            <div className={styles.col21}>
              <div className={styles.item54}>
                <div className={styles.paid5}>Paid</div>
                <div className={styles.div}>$1,900</div>
              </div>
              <div className={styles.item45}>
                <div className={styles.insurance}>Paid</div>
            ...
            <div className={styles.col11}>
              <div className={styles.item58}>
                ...
                <div className={styles.nataliTrump}>KTR Mobile Application</div>
                <div className={styles.img}>
                  <img className={styles.product71Icon} alt="" />
                </div>
              </div>
              <div className={styles.item48}>
                ...
                <div className={styles.nataliTrump}>Natali Trump</div>
                <img className={styles.avatarIcon3} alt="" />
              </div>
              <div className={styles.item38}>
                ...
                <div className={styles.item5Child} />
                <img className={styles.boy22Icon1} alt="" />
              </div>
            ...
            <div className={styles.head2}>
              ...
              <div className={styles.newArrivals}>New Arrivals</div>
              <div className={styles.moreThan4005}>
                More than 400+ new members
              </div>
            </div>
          </div>
          <div className={styles.widget61}>
            <div className={styles.col5}>
              <div className={styles.row5}>
                <img className={styles.buttonTrashIcon10} alt="" />
                <img className={styles.buttonEditIcon10} alt="" />
                <img className={styles.buttonSettingsIcon10} alt="" />
              </div>
              <div className={styles.row4}>
                <img className={styles.buttonTrashIcon10} alt="" />
                <img className={styles.buttonEditIcon10} alt="" />
            ...
            <div className={styles.col1}>
              <div className={styles.item51}>
                ...
                <div className={styles.item5Child} />
                <img className={styles.kickstarterIcon2} alt="" />
              </div>
              <div className={styles.item41}>
                <div className={styles.ftpBprowbnccc}>
                  <span className={styles.ftp}>FTP:</span>
              ...
              <div className={styles.item21}>
                ...
                <div className={styles.hrManagement}>Telegram Application</div>
                <div className={styles.item5Child} />
                <img className={styles.telegramIcon2} alt="" />
              </div>
              <div className={styles.item11}>
                <div className={styles.ftpBprowbnccc}>
                  <span className={styles.ftp}>FTP:</span>
          ...
          <div className={styles.widget2}>
            <div className={styles.item6}>
              ...
              <div className={styles.div22}>23:07</div>
            </div>
            <div className={styles.item512}>
              ...
              <div className={styles.div23}>21:03</div>
            </div>
            <div className={styles.item412}>
              <div className={styles.outlinesKeepYou4}>
                Outlines keep you honest. Indulging in poorly driving and keep
                structure keep you honest great
              </div>
              <div className={styles.item4Inner} />
              <div className={styles.item4Child1} />
              <div className={styles.div22}>16:50</div>
            </div>
            <div className={styles.item312}>
              <div className={styles.makeDepositUsdContainer}>
                <span>{`Make deposit `}</span>
                <span className={styles.xf2356}>USD 700</span>
                <span> to ESL</span>
              </div>
              <div className={styles.item3Child1} />
              <div className={styles.item3Child2} />
              <div className={styles.div25}>14:37</div>
            </div>
            <div className={styles.item212}>
              <img className={styles.userIcon3} alt="" />
              <img className={styles.userIcon4} alt="" />
              <img className={styles.userIcon5} alt="" />
              <div className={styles.aeolMeetingWith}>AEOL meeting with</div>
              <div className={styles.item2Inner} />
              <div className={styles.item2Child1} />
              <div className={styles.div26}>10:00</div>
            </div>
            <div className={styles.item112}>
              <div className={styles.outlinesKeepYou4}>
                Outlines keep you honest. Indulging in poorly driving and keep
                structure
              </div>
              <div className={styles.item1Inner} />
              <div className={styles.item1Child1} />
              <div className={styles.div22}>08:42</div>
            </div>
            <div className={styles.head5}>
              <div className={styles.sales1}>890,344 Sales</div>
          ...
          <div className={styles.widget11}>
            ...
            <div className={styles.top1}>
              <img className={styles.topChild} alt="" />
              <img className={styles.topItem} alt="" />
              <div className={styles.exportButton}>
                <div className={styles.button7} />
                <div className={styles.export}>Export</div>
                <img className={styles.arrowIcon2} alt="" />
              </div>
              <div className={styles.categories}>Categories</div>
            </div>
            <div className={styles.carts}>
              <div className={styles.cart4}>
                ...
                <img className={styles.stockholmIconsCommunicatio1} alt="" />
              </div>
              <div className={styles.cart3}>
                <div className={styles.background51} />
                <div className={styles.itemOrders}>Item Orders</div>
                <img className={styles.compilingIcon4} alt="" />
              </div>
              <div className={styles.cart2}>
                <div className={styles.background52} />
                <div className={styles.newUsers}>New Users</div>
                <img className={styles.addUserIcon1} alt="" />
              </div>
              <div className={styles.cart1}>
                <div className={styles.background53} />
                <div className={styles.equalizer2}>
                  <div className={styles.bound5} />
                  <div className={styles.rectangle62Copy9} />
                  <div className={styles.rectangle62Copy26} />
                  <div className={styles.rectangle62Copy46} />
                  <div className={styles.rectangle62Copy36} />
                </div>
        ...
        <img className={styles.quickToolsIcon} alt="" />
        <div className={styles.sidebar1}>
          <div className={styles.backgroundRectangle2} />
          <div className={styles.highlightedRectangle4} />
          <div className={styles.topPart1}>
            <div className={styles.highlightedRectangle5} />
            <img className={styles.arrowDoubleLeft1} alt="" />
            <div className={styles.metronic}>METRONIC</div>
          </div>
          <div className={styles.iconsBright}>
            <img className={styles.layersIcon2} alt="" />
            <img className={styles.layout4Blocks2} alt="" />
          </div>
          ...
          <div className={styles.subheadings1}>
            ...
            <div className={styles.icons1}>Icons</div>
          ...
          <img className={styles.iconsFaded1} alt="" />
          <img className={styles.arrowsIcon1} alt="" />
        </div>
        <div className={styles.sunheader}>
          <div className={styles.background35} />
          <div className={styles.left1}>
            ...
            <div className={styles.addNewButton3}>
              <div className={styles.addNewButtonChild} />
              <div className={styles.addNew}>Add New</div>
            </div>
          ...
          <div className={styles.right}>
            ...
            <img className={styles.filePlusIcon2} alt="" />
          </div>
        </div>
        <div className={styles.header}>
          <div className={styles.sep2} />
          <div className={styles.right3}>
            <div className={styles.icons2}>
              <img className={styles.searchIcon3} alt="" />
              <img className={styles.compilingIcon5} alt="" />
              <div className={styles.equalizer3}>
                <div className={styles.bound5} />
                <div className={styles.rectangle62Copy10} />
                <div className={styles.rectangle62Copy27} />
                <div className={styles.rectangle62Copy47} />
                <div className={styles.rectangle62Copy37} />
              </div>
              <img className={styles.stockholmIconsShoppingC3} alt="" />
              <img className={styles.layout4BlocksIcon4} alt="" />
              <img className={styles.flagIcon1} alt="" />
            </div>
            <div className={styles.hiSean}>
              <span>Hi,</span>
              <span className={styles.sean}> Sean</span>
            </div>
            <div className={styles.initialIcon1}>
              <div className={styles.rectangle50} />
        ...
        <img className={styles.toggleIcon2} alt="" />
        <img className={styles.toggleIcon3} alt="" />
      </div>
      <div className={styles.widget21}>
        <div className={styles.chart}>
          ...
          <div className={styles.xAxis}>
            ...
            <div className={styles.sep4}>5 Sep</div>
          </div>
          <div className={styles.yAxis}>
            <div className={styles.div28}>150</div>
            <div className={styles.div29}>120</div>
            <div className={styles.div30}>90</div>
            <div className={styles.div31}>60</div>
            <div className={styles.div32}>30</div>
            <div className={styles.div33}>0</div>
          </div>
          <div className={styles.columns}>
            ...
            <div className={styles.column2}>
              <img
                ...
                src="/rectangle-169@2x.png"
              />
              <div className={styles.columnChild2} />
            </div>
            <div className={styles.column3}>
              <img
                className={styles.columnChild3}
                alt=""
                src="/rectangle-169@2x.png"
              />
              <div className={styles.columnChild4} />
            </div>
            <div className={styles.column4}>
              <img
                className={styles.columnChild5}
                alt=""
                src="/rectangle-169@2x.png"
              />
              <div className={styles.columnChild6} />
            </div>
            <div className={styles.column5}>
              <img
                className={styles.columnChild7}
                alt=""
                src="/rectangle-169@2x.png"
              />
              <div className={styles.columnChild8} />
            </div>
          </div>
        </div>
        <div className={styles.top2}>
          ...
          <div className={styles.moreThan4007}>More than 400+ new members</div>
        </div>
      </div>
    </div>
  );
